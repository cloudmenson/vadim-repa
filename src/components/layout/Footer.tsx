...
export function Footer({ dict }: { dict: Dictionary["footer"] }) {
  return (
    <footer
      id="contact"
      className="bg-[#001a33] text-white py-20 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="p-2 bg-white/5 hover:bg-brand-light-blue transition-colors rounded-full"
              >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <a
                    ...
                    className="block hover:text-brand-light-blue transition-colors font-bold"
                  >
                    +38 (097) 529 94 95
                  </a>
                  <a
                    href="tel:+380960229918"
                    className="block hover:text-brand-light-blue transition-colors font-bold"
                  >
                    +38 (096) 022 99 18
                  </a>
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="hover:text-brand-light-blue transition-colors font-bold"
                >
