...
const steps = [
  {
    ...
    description: "Зателефонуйте нам або заповніть форму на сайті для отримання консультації.",
  },
  {
    number: "02",
    title: "Ми прораховуємо маршрут і вартість",
    description: "Підбираємо оптимальний транспорт та розраховуємо найвигідніший тариф.",
  },
  {
    number: "03",
    title: "Оформлюємо документи",
    description: "Готуємо повний пакет документів для безпечного та легального перевезення.",
  },
  {
    number: "04",
    title: "Доставляємо вантаж точно в термін",
    description: "Здійснюємо доставку та надаємо повний звіт про місцезнаходження вантажу.",
  },
];
